...
# bow
# 3 layers, yes/no (top 2)
run_model(epochs=5, model_name='3L_yes_no_dropout', layers=3, check_top_ans=2, removeYesNo=False, get_data=bow_get_data, type='bow')
...
# 5 layers, yes/no (top 2)
run_model(epochs=5, model_name='5L_yes_no_dropout', layers=5, check_top_ans=2, removeYesNo=False, get_data=bow_get_data, type='bow')
