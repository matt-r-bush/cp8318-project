...
def main():
    ...
    test_qs = json.load(open('data/testing_questions/MultipleChoice_abstract_v002_test2015_questions.json', 'r'))
    ...
    # image_set = 'test2015'
    # for i in range(len(test_qs['questions'])):
    #     question_id = test_qs['questions'][i]['question_id']
    #     image_path = imdir%(image_folder, image_set, test_qs['questions'][i]['image_id'])

    #     question = test_qs['questions'][i]['question']
    #     mc_ans = test_qs['questions'][i]['multiple_choices']
